from courses.views import AddComment, CourseDetail, CourseManage, CourseSearch, CourseStudy, CoursesHomeViews, \
    CourseManageCourseList, GetCartDetail, SearchCourse
