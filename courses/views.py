...
from courses.serializers import CartItemSerializer, CommentSerializer, CourseDisplaySerializer, CourseListSerializer, \
    CoursePaidSerializer, CourseUnPaidSerializer, SectorSerializer
